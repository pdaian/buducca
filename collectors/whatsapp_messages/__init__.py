...
def create_collector(config: dict):
    ...
    session_file = str(config.get("session_file") or os.environ.get("WHATSAPP_SESSION_FILE", ""))
    command = config.get("command") or os.environ.get("WHATSAPP_EXPORT_COMMAND", "")
    ...
    def _run(workspace: Workspace) -> None:
        ...
        for message in messages:
            ...
            out.append({"source": "whatsapp", "received_at": now, **message})
